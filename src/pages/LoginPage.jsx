...
const ss = {
  ...
  card:   { background: '#1a1a24', border: `1px solid ${colors.border}`, borderRadius: 24, padding: '40px 36px', width: 340, display: 'flex', flexDirection: 'column', gap: 16, boxShadow: '0 32px 80px rgba(0,0,0,0.5)' },
